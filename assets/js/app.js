...
if (session == null) {
	...
	// create a button in body 
	let loginButton = document.createElement('button');
	loginButton.setAttribute('id', 'loginButton');
	loginButton.setAttribute('class', 'btn btn-primary');
	loginButton.setAttribute('onclick', 'window.location.href = window.location.origin + "/login";');
	loginButton.innerText = 'Login';
	document.getElementById('container').append(loginButton);
} else {
	let bankValue = 0;
	let currentBet = 0;
	let wager = 5;
